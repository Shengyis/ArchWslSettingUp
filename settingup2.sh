...
pacman -Syyu gvim git wget adobe-source-sans-fonts cronie base-devel zsh --noconfirm
...
sudo pacman -S blas-openblas python tk python-matplotlib python-scipy python-mpmath ghostscript popplar --noconfirm
EOF
